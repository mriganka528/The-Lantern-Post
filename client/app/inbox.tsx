...
export default function InboxScreen() {
  ...
  return <PalaceLetterbox key={ownerId} ownerId={ownerId} api={api} onBack={() => router.replace('/')} onWrite={() => router.push('/writing-desk')} onReply={person => router.push({ pathname: '/writing-desk', params: { recipient: person.id } })} />;
}
