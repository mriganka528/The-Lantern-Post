...
export function EnvelopeArt({ preset, width = 170 }: { preset: LetterPreset; width?: number }) {
  ...
  return <View accessibilityElementsHidden importantForAccessibility="no-hide-descendants" style={[{ width, height, backgroundColor: preset.config.paperColor, borderWidth: 1, borderColor: preset.config.ribbonColor, borderRadius: 3, overflow: 'hidden' }, { pointerEvents: "none" }]}>
